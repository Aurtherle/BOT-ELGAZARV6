...
global.packname = "مادارا العم السقف" //ur sticker waterk packname
global.author = "⍣01098906252⍣" //ur sticker watermark author
global.Take = "Madara" //ur watermark
...
global.mess = {
    success: 'تممم 💫',
    admin: '『 يجب ان تكون مشرف لاستخدام هذا الامر 』',
    botAdmin: '『 لأقوم ببعض الاوامر يجب علي ان اكون مشرف„حسنا؟ 』',
    premime: '『 ميزات خاصة متميزة إذا كنت ترغب في تسجيل نوع الإيجار 』',
    owner: '『 هذه الميزة للمطور فقط 』',
    group: '『 هذه الميزة للقروبات فقط 』',
    private: '『 هذه الميزة للخاص فقط 』',
    bot: '『 هذه الميزة للبوت فقط 』',
    wait: '『 انتظر قليلاً وسيتم تنفيذ طلبك 』',
    linkm: '『 ضع الرابط! 』',
